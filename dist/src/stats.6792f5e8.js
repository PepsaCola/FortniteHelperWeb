...
const createResultStatsSolo = (data)=>{
    return `
    <ul class='stats-list'>
      <li class='stats-item'>
        <ul class='row-stats-list'>
...
const createResultStatsDuo = (data)=>{
    return `
    <ul class='stats-list'>
      <li class='stats-item'>
        <ul class='row-stats-list'>
...
const createResultStatsSquad = (data)=>{
    return `
    <ul class='stats-list'>
      <li class='stats-item'>
        <ul class='row-stats-list'>
