...
})({"2clkq":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "8519ba2009f91455";
"use strict";
...
},{}],"9j68q":[function(require,module,exports,__globalThis) {
...
document.querySelector('.cosmetic-search-result-list').addEventListener('click', (event)=>{
    ...
    if (item) {
        ...
        if (itemDescription != null) document.querySelector('.modal-text').textContent = itemDescription;
        else if (item.getAttribute('data-artist') != null) document.querySelector('.modal-text').innerHTML = `
    ...
    `;
        else document.querySelector('.modal-text').textContent = '';
        if (item.getAttribute('data-chapter') != null) document.querySelector('.modal-text').innerHTML = `
            ${itemDescription}<br>
...
},{}]},["2clkq","9j68q"], "9j68q", "parcelRequire94c2")

//# sourceMappingURL=cosmetics.09f91455.js.map
